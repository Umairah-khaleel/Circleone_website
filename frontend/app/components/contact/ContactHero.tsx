...
// ContactHero: Displays page title, breadcrumb, tagline, and contact illustration graphic with hover helper
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
        ...
        <div className="w-full md:w-1/2 text-left pl-2 md:pl-4">
          <div className="flex items-center gap-2 text-xs md:text-sm text-gray-500 mb-3">
            ...
            <span>&gt;</span>
            <span className="text-[#FF6600] font-medium">Contact</span>
          </div>
          ...
          <p className="text-[#4A5568] text-sm md:text-base mt-3 max-w-lg leading-relaxed">
            We’d love to hear from you. Let’s discuss how Circle One can help your business grow.
          </p>
        </div>
